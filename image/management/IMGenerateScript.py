...
#Move next 3 to deploy        
    ...
    if (re.search("^5", version)):
        ...
        runCmd('chroot ' + tempdir + '' + name + ' rpm -ivh ' + http_server + '/centos/conf/epel-release-5-4.noarch.rpm')
        ...
        runCmd('chroot ' + tempdir + '' + name + ' rpm -ivh ' + http_server + '/centos/conf/epel-release-6-5.noarch.rpm')
